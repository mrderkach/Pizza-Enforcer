...
public class BackgroundMusic : MonoBehaviour
{
    ...
    void Start() 
     {
        ...
        /*
         if (obj == null)
         {
             ...
             playerSettings.MusicSetting = (MusicSetting) gameObject.GetComponent<DataStorage>().music_mode+1;//MusicSetting.Audio1;
         }
         else
         {
             playerSettings = obj.GetComponent<PlayerSettings>();
         }*/
        playerSettings.MusicSetting = (MusicSetting)gameObject.GetComponent<ChooseCharacter>().dataStorage.music_mode + 1;
        setupBGM();
    ...
    private void Update()
    {
        //Debug.Log(playerSettings.MusicSetting);
